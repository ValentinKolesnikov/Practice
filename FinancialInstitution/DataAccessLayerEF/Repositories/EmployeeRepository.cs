    ...
    public class EmployeeRepository: Repository, IEmployeeRepository
    {
        ...
        public void Update(int employeeId, Employee employee)
        {
            using (dataBase = new FinancialInstitutionEntities())
            {
                ...
                changeableEmployee.FirstName = employee.FirstName;
                changeableEmployee.SecondName = employee.SecondName;
                changeableEmployee.MiddleName = employee.MiddleName;
                changeableEmployee.BirthDay = employee.BirthDay;
                changeableEmployee.PositionId = employee.PositionId;
                changeableEmployee.BranchId = employee.BranchId;
